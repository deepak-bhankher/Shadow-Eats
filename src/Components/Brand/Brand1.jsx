    ...
    <section className="relative min-h-screen w-full flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto flex flex-col items-center text-center gap-8 sm:gap-10 mt-16 sm:mt-24">
        ...
        >
          ...
          <span
            style={{ fontFamily: "Cormorant Garamond, serif", fontWeight: 300, fontStyle: "italic", fontSize: "1.12em", color: "#fff" }}
          >
            Shadow Eats
          </span>{" "}
        ...
        <motion.p
          ...
          style={{ fontFamily: "Inter, sans-serif", fontWeight: 300, letterSpacing: "0.1em" }}
        >
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, delay: 0.45, type: "spring", stiffness: 180 }}
